...
a value fetched from a web service, a mode you set at the start of the night. The
related [Recurring Tasks](#recurring-tasks) page works alongside this one. Both
appear once your **UI Level** is **Advanced** or higher (see
[FPP Settings → UI](#ui)).
